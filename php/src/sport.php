    ...
    <div id="center">
      ...
      ?>
        <div class="spost">
          ...
          <p><?php echo $data["berita_tanggal"];?>- 14:37 WIB &#8230; <a href="sp1.php">Read more &raquo;</a></p>
        </div>
        <!-- wn2 -->
      ...
      ?>
        <div class="spost">
          <h2><?php echo $data["berita_judul"]; ?></h2>
          <?php echo "<img src=images/".$data['berita_gambar'].">"; ?>
          <p><?php echo $data["berita_tanggal"];?> -18:18 WIB &#8230; <a href="sp2.php">Read more &raquo;</a></p>
        </div>
        <!-- wn3 -->
        <div class="spbottom"></div>
        <?php 
      ...
      ?>
        <div class="spost">
          <h2><?php echo $data["berita_judul"]; ?></h2>
          <?php echo "<img src=images/".$data['berita_gambar'].">"; ?>
          <p><?php echo $data["berita_tanggal"];?> -14:19 WIB &#8230; <a href="sp3.php">Read more &raquo;</a></p>
        </div>
        <!-- /spost -->
        <div class="spbottom"></div>
      </div>
      ...
      ?>
        <div class="spost">
          <h2><?php echo $data["berita_judul"]; ?></h2>
          <?php echo "<img src=images/".$data['berita_gambar'].">"; ?>
          <p><?php echo $data["berita_tanggal"];?> -20:26 WIB  &#8230; <a href="sp4.php">Read more &raquo;</a></p>
        </div>
        <!-- /spost -->
        <div class="spbottom"></div>
        <?php 
      ...
      ?>
        <div class="spost">
          <h2><?php echo $data["berita_judul"]; ?></h2>
          <?php echo "<img src=images/".$data['berita_gambar'].">"; ?>
          <p><?php echo $data["berita_tanggal"];?> -12:09 WIB &#8230; <a href="sp5.php">Read more &raquo;</a></p>
        </div>
        <!-- /spost -->
        <div class="spbottom"></div>
        <?php 
      ...
      ?>
        <div class="spost">
          <h2><?php echo $data["berita_judul"]; ?></h2>
          <?php echo "<img src=images/".$data['berita_gambar'].">"; ?>
          <p><?php echo $data["berita_tanggal"];?> -08:38 WIB &#8230; <a href="sp6.php">Read more &raquo;</a></p>
        </div>
        <!-- /spost -->
        <div class="spbottom"></div>
      </div>
      ...
      ?>
        <div class="spost">
          <h2><?php echo $data["berita_judul"]; ?></h2>
          <?php echo "<img src=images/".$data['berita_gambar'].">"; ?>
          <p><?php echo $data["berita_tanggal"];?> - 08:08 WIB &#8230; <a href="sp7.php">Read entire article &raquo;</a></p>
        </div>
        <!-- /spost -->
        <div class="spbottom"></div>
        <?php 
      ...
      ?>
        <div class="spost">
          <h2><?php echo $data["berita_judul"]; ?></h2>
          <?php echo "<img src=images/".$data['berita_gambar'].">"; ?>
          <p><?php echo $data["berita_tanggal"];?> - 11:36 WIB &#8230; <a href="sp8.php">Read entire article &raquo;</a></p>
        </div>
        <!-- /spost -->
        <div class="spbottom"></div>
        <?php 
      ...
      ?>
        <div class="spost">
          <h2><?php echo $data["berita_judul"]; ?></h2>
          <?php echo "<img src=images/".$data['berita_gambar'].">"; ?>
          <p><?php echo $data["berita_tanggal"];?> - 21:06 WIB &#8230; <a href="sp9.php">Read entire article &raquo;</a></p>
        </div>
        </div>
        <!-- /navigation -->
      </div>
