    ...
    <div id="center">
      ...
      ?>
        <div class="spost">
          ...
          <p><?php echo $data["berita_tanggal"];?> - 07:27 WIB &#8230; <a href="t1.php">Read more &raquo;</a></p>
        </div>
        <!-- wn2 -->
      ...
      ?>
        <div class="spost">
          <h2><?php echo $data["berita_judul"]; ?></h2>
          <?php echo "<img src=images/".$data['berita_gambar'].">"; ?>
          <p><?php echo $data["berita_tanggal"];?> - 23:45 WIB &#8230; <a href="t2.php">Read more &raquo;</a></p>
        </div>
        <!-- wn3 -->
        <div class="spbottom"></div>
        <?php 
      ...
      ?>
        <div class="spost">
          <h2><?php echo $data["berita_judul"]; ?></h2>
           <?php echo "<img src=images/".$data['berita_gambar'].">"; ?>
          <p><?php echo $data["berita_tanggal"];?> - 00:21 WIB &#8230; <a href="t3.php">Read more &raquo;</a></p>
        </div>
        <!-- /spost -->
        <div class="spbottom"></div>
      </div>
      ...
      ?>
        <div class="spost">
          <h2><?php echo $data["berita_judul"]; ?></h2>
          <?php echo "<img src=images/".$data['berita_gambar'].">"; ?>
          <p><?php echo $data["berita_tanggal"];?> - 13:02 WIB  &#8230; <a href="t4.php">Read more &raquo;</a></p>
        </div>
        <!-- /spost -->
        <div class="spbottom"></div>
        <?php 
      ...
      ?>
        <div class="spost">
          <h2><?php echo $data["berita_judul"]; ?></h2>
          <?php echo "<img src=images/".$data['berita_gambar'].">"; ?>
          <p><?php echo $data["berita_tanggal"];?> - 14:49 WIB &#8230; <a href="t5.php">Read more &raquo;</a></p>
        </div>
        <!-- /spost -->
        <div class="spbottom"></div>
        <?php 
      ...
      ?>
        <div class="spost">
          <h2><?php echo $data["berita_judul"]; ?></h2>
          <?php echo "<img src=images/".$data['berita_gambar'].">"; ?>
          <p><?php echo $data["berita_tanggal"];?> - 05:01 WIB &#8230; <a href="t6.php">Read more &raquo;</a></p>
        </div>
        <!-- /spost -->
        <div class="spbottom"></div>
      </div>
      ...
      ?>
        <div class="spost">
          <h2><?php echo $data["berita_judul"]; ?></h2>
          <?php echo "<img src=images/".$data['berita_gambar'].">"; ?>
          <p><?php echo $data["berita_tanggal"];?> - 08:08 WIB &#8230; <a href="t7.php">Read entire article &raquo;</a></p>
        </div>
        <!-- /spost -->
        <div class="spbottom"></div>
        <?php 
      ...
      ?>
        <div class="spost">
          <h2><?php echo $data["berita_judul"]; ?></h2>
          <?php echo "<img src=images/".$data['berita_gambar'].">"; ?>
          <p><?php echo $data["berita_tanggal"];?> - 11:36 WIB &#8230; <a href="t8.php">Read entire article &raquo;</a></p>
        </div>
        <!-- /spost -->
        <div class="spbottom"></div>
        <?php 
      ...
      ?>
        <div class="spost">
          <h2><?php echo $data["berita_judul"]; ?></h2>
          <?php echo "<img src=images/".$data['berita_gambar'].">"; ?>
          <p><?php echo $data["berita_tanggal"];?> - 21:06 WIB &#8230; <a href="t9.php">Read entire article &raquo;</a></p>
        </div>
        </div>
        <!-- /navigation -->
      </div>
